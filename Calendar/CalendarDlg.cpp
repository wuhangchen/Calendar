...
{
	//WORD year, month, day;
	//WORD holday = CCalendar::GetLunarDate(2000, 2, 6, year, month, day); 
	//char text[100];
	//sprintf(text, "2000年2月6日是阴历%d年%d月%d日",year, month, day);
	//MessageBox(text);
	static WORD month = 0;

	m_oCalendar.SetDate(2000, month % 12 + 1, 1);
	m_oCalendar.Invalidate();
